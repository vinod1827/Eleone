    ...
    public static void callApi(final Context context, String url, JSONObject jsonObject,
        ...
        JsonObjectRequest jsonObjReq = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                //  Log.e(Variables.tag+urlsplit[urlsplit.length-1],error.toString());
                //Toast.makeText(context, "Api run timeout", Toast.LENGTH_SHORT).show();
                if (callbackListener != null)
                    callbackListener.onResponse(error.toString());
        ...
        if (Variables.IS_DEBUG) {
            ...
            System.out.println("### Request Parameters -> " + jsonObject);
        }
