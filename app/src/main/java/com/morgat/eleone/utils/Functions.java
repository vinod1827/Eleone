...
public class Functions {
    ...
    public static void callApiForLikeVideo(final Activity activity,
                                           ...
                                           final ApiCallbackListener apiCallbackListener) {
        ...
        ApiRequest.callApi(activity, Variables.likeDislikeVideo, parameters, new CallbackListener() {
            @Override
            public void onResponse(String resp) {
                apiCallbackListener.onSuccess(resp);
            }
        });
    ...
    public static void callApiForSendComment(final Activity activity, String video_id, String comment , final ApiCallbackListener apiCallbackListener) {
        ...
        ApiRequest.callApi(activity, Variables.postComment, parameters, new CallbackListener() {
            @Override
            public void onResponse(String resp) {
                ...
                try {
                    ...
                    if(code.equals("200")){
                        ...
                        apiCallbackListener.onResponseArrayReceived(arrayList);
                    ...
                    apiCallbackListener.onFailure(e.toString());
                    e.printStackTrace();
                }
    ...
    public static void Call_Api_For_get_Comment(final Activity activity, String video_id, final ApiCallbackListener apiCallbackListener) {
        ...
        ApiRequest.callApi(activity, Variables.showVideoComments, parameters, new CallbackListener() {
            @Override
            public void onResponse(String resp) {
                ArrayList<CommentModel> arrayList=new ArrayList<>();
                try {
    ...
    public static void Call_Api_For_Follow_or_unFollow
        ...
        try {
          ...
          ApiRequest.callApi(activity, Variables.follow_users, parameters, new CallbackListener() {
            @Override
            public void onResponse(String resp) {
                ...
                try {
                    ...
                    String code=response.optString("code");
                    if(code.equals("200")){
                        apiCallbackListener.onSuccess(response.toString());
    ...
    public static void callApiForGetUserData
        ...
        ApiRequest.callApi(activity, Variables.get_user_data, parameters, new CallbackListener() {
            @Override
            public void onResponse(String resp) {
                Functions.cancelLoader();
                try {
    ...
    public static void Call_Api_For_Delete_Video
        ...
        ApiRequest.callApi(activity, Variables.DeleteVideo, parameters, new CallbackListener() {
            @Override
            public void onResponse(String resp) {
                Functions.cancelLoader();
                try {
