...
import com.morgat.eleone.services.UploadIntentService;
import com.morgat.eleone.utils.Functions;
import com.morgat.eleone.utils.Variables;

import java.io.File;

public class PostVideoActivity extends AppCompatActivity implements ServiceCallbackListener {
    ...
    ServiceCallbackListener serviceCallbackListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video_path = Variables.getRootPath(this)+Variables.output_filter_file;
...
// this will start the service for uploading the video into database
    public void Start_Service(){
        ...
        serviceCallbackListener =this;

        UploadIntentService mService = new UploadIntentService(serviceCallbackListener);
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className,
           ...
           UploadIntentService.LocalBinder binder = (UploadIntentService.LocalBinder) service;
