...
import com.morgat.eleone.components.MovieWrapperView;
import com.morgat.eleone.utils.FilterType;
import com.morgat.eleone.adapters.FilterAdapter;
...
public class PreviewVideoActivity extends AppCompatActivity  implements Player.EventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        video_url= Variables.getRootPath(this)+Variables.outputfile2;
        ...
        findViewById(R.id.next_btn).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Save_Video(Variables.getRootPath(PreviewVideoActivity.this)+Variables.outputfile2,Variables.getRootPath(PreviewVideoActivity.this)+Variables.output_filter_file);
            }
        });
