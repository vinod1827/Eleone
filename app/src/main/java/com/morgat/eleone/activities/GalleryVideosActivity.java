...
import com.morgat.eleone.adapters.GalleryVideosAdapter;
...
public class GalleryVideosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new GalleryVideosAdapter(this, data_list, new GalleryVideosAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(int postion, GalleryVideoModel item, View view) {
                ...
                if (item.video_duration_ms < 19500) {
                    Chnage_Video_size(item.video_path, Variables.getRootPath(GalleryVideosActivity.this)+Variables.gallery_resize_video);

                } else {
                    try {
                        startTrim(new File(item.video_path), new File(Variables.getRootPath(GalleryVideosActivity.this)+Variables.gallery_trimed_video), 1000, 18000);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
    ...
    public void getAllVideoPath() {
        new MediaLoader().execute();
    }

    private class MediaLoader extends  AsyncTask<Void,Void,Cursor>{
        ...
        protected Cursor doInBackground(Void... voids) {
            ...
            if (cursor != null) {
                while (cursor.moveToNext()) {
                    GalleryVideoModel item = new GalleryVideoModel();
    ...
    private void enableList(boolean b) {
        if(b){
                    ...
                    public void onCompleted() {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                intent.putExtra("video_path", Variables.getRootPath(GalleryVideosActivity.this)+Variables.gallery_resize_video);
        ...
        new AsyncTask<String, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                if (result.equals("error")) {
                    ...
                    Chnage_Video_size(Variables.getRootPath(GalleryVideosActivity.this)+Variables.gallery_trimed_video, Variables.getRootPath(GalleryVideosActivity.this)+Variables.gallery_resize_video);
                }
            }
    ...
    public void DeleteFile() {
        ...
        File gallery_trim_video = new File(Variables.getRootPath(this)+Variables.gallery_trimed_video);
        File gallery_resize_video = new File(Variables.getRootPath(this)+Variables.gallery_resize_video);
