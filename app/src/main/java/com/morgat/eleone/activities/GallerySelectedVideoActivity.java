...
import static com.morgat.eleone.activities.VideoRecordingActivity.Sounds_list_Request_code;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if(audio!=null){
                        outputFilePath=Variables.getRootPath(GallerySelectedVideoActivity.this)+Variables.outputfile;
                    }else {
                        outputFilePath=Variables.getRootPath(GallerySelectedVideoActivity.this)+Variables.outputfile2;
                    }
