...
public class NotificationFragment extends FirebaseMessagingService {
    ...
    public void onNewToken(String s) {
        ...
        if (s == null) {
            ...
            ElevenApp.Companion.getPreffs().setFirebasetoken(s);
        }
    ...
    private class sendNotification extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap result) {
            ...
            if (MainMenuActivity.mainMenuActivity != null) {
                ...
                TextView titletxt = layout.findViewById(R.id.userNameTextView);
                TextView messagetxt = layout.findViewById(R.id.message);
                ImageView imageView = layout.findViewById(R.id.userImage);
