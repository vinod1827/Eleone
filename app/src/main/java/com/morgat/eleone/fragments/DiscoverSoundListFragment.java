...
import com.morgat.eleone.adapters.Sounds_Adapter;
import com.morgat.eleone.application.ElevenApp;
import com.morgat.eleone.fragments.RootFragment;
import com.morgat.eleone.R;
import com.morgat.eleone.models.SoundCategoryModel;
import com.morgat.eleone.models.SoundsModel;
...
public class DiscoverSoundListFragment extends RootFragment implements Player.EventListener {
    ...
    ArrayList<SoundCategoryModel> datalist;
    ...
    private void Call_Api_For_get_allsound() {
        ...
        ApiRequest.callApi(context, Variables.allSounds, parameters, new CallbackListener() {
            @Override
        ...
        try {
            ...
            if (code.equals("200")) {
                ...
                for (int i = msgArray.length() - 1; i >= 0; i--) {
                    ...
                    SoundCategoryModel sound_catagory_get_set = new SoundCategoryModel();
    ...
    public void downLoadMp3(final String id, final String sound_name, String url) {
        ...
        prDownloader = PRDownloader.download(url, Variables.getRootPath(requireActivity()), Variables.SelectedAudio_AAC)
                .build()
    ...
    private void callApiForFavSound(String video_id) {
        ...
        ApiRequest.callApi(context, Variables.fav_sound, parameters, new CallbackListener() {
            @Override
            public void onResponse(String resp) {
                iosDialog.cancel();
            }
