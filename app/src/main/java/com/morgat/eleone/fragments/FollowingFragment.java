...
import com.morgat.eleone.adapters.FollowingAdapter;
import com.morgat.eleone.application.ElevenApp;
import com.morgat.eleone.models.FollowingModel;
...
public class FollowingFragment extends Fragment {
    ...
    public FollowingFragment(FragmentCallbackListener fragment_callbackListener) {
            ...
            public void onItemClick(View view, int postion, FollowingModel item) {
                ...
                switch (view.getId()){
                    case R.id.action_txt:
                        if(user_id.equals(ElevenApp.Companion.getPreffs().getUserModel().getId()))
    ...
    private void Call_Api_For_get_Allfollowing() {
        ...
        ApiRequest.callApi(context, Variables.get_followings, parameters, new CallbackListener() {
            @Override
    ...
    private void Call_Api_For_get_Allfan() {
        ...
        ApiRequest.callApi(context, Variables.get_followers, parameters, new CallbackListener() {
            @Override
            public void onResponse(String resp) {
    ...
    public void Follow_unFollow_User(final FollowingModel item, final int position){
        ...
        Functions.Call_Api_For_Follow_or_unFollow(getActivity(),ElevenApp.Companion.getPreffs().getUserModel().getId(),
                item.fb_id,
                send_status,
