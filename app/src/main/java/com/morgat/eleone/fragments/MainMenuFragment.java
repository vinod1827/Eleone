...
import com.morgat.eleone.accounts.views.LoginActivity;
import com.morgat.eleone.components.CustomViewPager;
...
import com.morgat.eleone.activities.VideoRecordingActivity;
...
public class MainMenuFragment extends RootFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        context = getContext();
        tabLayout = (TabLayout) view.findViewById(R.id.mainMenuTabLayout);
    ...
    private void setupTabIcons() {
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener() {
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                tab.setCustomView(v);
                tabLayout.setBackground(ContextCompat.getDrawable(requireActivity(), R.drawable.gradient_background));
            }
            ...
            public void onClick(View v) {
                if (check_permissions()) {
                    if (ElevenApp.Companion.getPreffs().getUserModel() != null) {
                        navigateToVideoRecordingActvity();
                    } else {
    ...
    private void navigateToVideoRecordingActvity() {
        Intent intent = new Intent(requireActivity(), VideoRecordingActivity.class);
        startActivity(intent);
        requireActivity().overridePendingTransition(R.anim.in_from_bottom, R.anim.out_to_top);
    }
    ...
    public void OnHome_Click() {
        ...
        image.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_video_new));
    ...
    public void onotherTabClick() {
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        params.addRule(RelativeLayout.ABOVE, R.id.profileTabLayout);
        pager.setLayoutParams(params);
