...
public class Sounds_Adapter extends RecyclerView.Adapter<Sounds_Adapter.CustomViewHolder >  {
    ...
    public Sounds_Adapter(Context context, ArrayList<SoundCategoryModel> arrayList, Sounds_Adapter.OnItemClickListener listener) {
    ...
    public void onBindViewHolder(final Sounds_Adapter.CustomViewHolder holder, final int i) {
        holder.setIsRecyclable(false);
          ...
          SoundCategoryModel item=datalist.get(i);
...
class Sound_Items_Adapter extends RecyclerView.Adapter<Sound_Items_Adapter.CustomViewHolder > {
    ...
    public Sound_Items_Adapter(Context context, ArrayList<SoundsModel> arrayList, Sound_Items_Adapter.OnItemClickListener listener) {
        this.context = context;
        datalist= arrayList;
        this.listener=listener;
    }
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final int pos , final SoundsModel item, final Sound_Items_Adapter.OnItemClickListener listener) {
