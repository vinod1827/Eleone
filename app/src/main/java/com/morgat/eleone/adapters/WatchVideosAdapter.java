...
public class WatchVideosAdapter extends RecyclerView.Adapter<WatchVideosAdapter.CustomViewHolder> {
    ...
    public WatchVideosAdapter(Context context, ArrayList<HomeModel> dataList, WatchVideosAdapter.OnItemClickListener listener) {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView user_pic, sound_image, moreOption;
