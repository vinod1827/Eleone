...
public class Favourite_Sound_Adapter extends RecyclerView.Adapter<Favourite_Sound_Adapter.CustomViewHolder > {
    ...
    public Favourite_Sound_Adapter(Context context, ArrayList<SoundsModel> arrayList, Favourite_Sound_Adapter.OnItemClickListener listener) {
    ...
    class CustomViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final int pos , final SoundsModel item, final Favourite_Sound_Adapter.OnItemClickListener listener) {
